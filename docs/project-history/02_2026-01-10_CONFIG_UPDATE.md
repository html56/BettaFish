<!--
文档用途: 记录 LLM 配置和数据库连接参数的更新过程
创建时间: 2026-01-10
文档类型: 配置文档
内容概要: 详细说明了如何配置 LLM API 密钥、Base URL、模型名称,以及数据库连接参数
相关背景: 项目使用多个 LLM Agent 进行舆情分析,需要正确配置各个 Agent 的 LLM 参数
维护说明: 新增 LLM 服务或更改配置方式时需更新本文档
-->
